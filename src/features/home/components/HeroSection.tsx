      ...
      <div className="relative z-20 text-center max-w-5xl mx-auto mobile-safe-padding">
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-4">
            ...
            <h1 data-testid="hero-title" className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight">
              <span className="text-accent">Ani</span>
              <span className="text-gradient-primary">thing</span>
            </h1>
            <h2 data-testid="hero-subtitle" className="text-2xl md:text-3xl lg:text-4xl font-semibold text-foreground/90">
          ...
          {/* Search Section */}
          <div className="max-w-4xl mx-auto space-y-6 relative z-30" data-testid="hero-search">
