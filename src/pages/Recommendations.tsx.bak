...
// Define the recommendation shape expected from the hook/DB
...
const Recommendations = () => {
  ...
  const typedRecs = (recommendations as unknown as Recommendation[]) || [];
  const animeRecommendations = typedRecs.filter((rec) => !!rec.anime_id);
  const mangaRecommendations = typedRecs.filter((rec) => !!rec.manga_id);
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      >
                        ...
                        <span className="ml-1">
                          {rec.recommendation_type.replace('_', ' ').replace(/\b\w/g, (l: string) => l.toUpperCase())}
                        </span>
                      </Badge>
