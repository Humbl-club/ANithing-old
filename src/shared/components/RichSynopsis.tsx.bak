...
export const RichSynopsis = ({ 
  ...
  if (!synopsis) {
    return (
      <Card data-testid="detail-synopsis" className={`border-border/50 bg-card/50 backdrop-blur-sm shadow-lg ${className}`}>
        <CardContent className="p-8">
          <h3 data-testid="detail-synopsis-title" className="text-2xl font-bold mb-4 flex items-center gap-2">
    ...
    <Card data-testid="detail-synopsis" className={`border-border/50 bg-card/50 backdrop-blur-sm shadow-lg ${className}`}>
      <CardContent className="p-8">
        <div className="flex items-center justify-between mb-4">
          <h3 data-testid="detail-synopsis-title" className="text-2xl font-bold flex items-center gap-2">
            <BookOpen className="w-6 h-6 text-primary" />
            Synopsis
          </h3>
