...
export const LazyAdvancedFiltering = lazy(() => import('@/shared/components/AdvancedFiltering'));
export const LazyContentGrid = lazy(() => import('@/shared/components/ContentGrid'));
export const LazySearchWithFilters = lazy(() => import('@/features/search/components/SearchWithFilters'));
